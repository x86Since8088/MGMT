...
Write-Verbose -Message "MGMT: Loading indivifual functions from $script:MGMTFolder\functions" -Verbose
Get-ChildItem $script:MGMTFolder\functions\*.ps1 | ForEach-Object{
