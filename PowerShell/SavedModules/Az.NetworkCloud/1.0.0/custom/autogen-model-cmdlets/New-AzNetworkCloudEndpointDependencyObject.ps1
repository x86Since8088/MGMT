...
function New-AzNetworkCloudEndpointDependencyObject {
    ...
    Param(
        ...
        [Parameter(Mandatory, HelpMessage="The domain name of the dependency.")]
        [string]
        $DomainName,
        [Parameter(HelpMessage="The port of this endpoint.")]
        [long]
        $Port
    )
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAq4htNaCpIHWfR
# tr+Huk7VZqCZmkpRkyvWgIeb/Ytw6KCCDYUwggYDMIID66ADAgECAhMzAAADTU6R
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINo0
# /Y4mxft40qpYu5FAS5gd/J6NkM2vLukeT/bvuxP+MEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAHr+C7fFtgyiDX4IpMbBd9kMF7VgPWcvBg6E6
# 7KlCW9hVeJQBFgUw32+HG4TnOn2tRIgiOX9Jtcd32t+9R81QjUdtSWUWiqfg/txX
# j7RN6ziMuEGvNWcvuHrDEUM7BUvMLDNZve/AHhvxlE51iOFxUwkqtuQ1JETrFIZ0
# UbEc/ogwiMrl9nEe8tWl9gw+XEGaOCD8tJhLWewUiFNx80fqbVbQ4H7NYcB+6OXy
# yTw1FCNPjVDRmW0LteNZqG2tMTF6ICtjTSSUOzJAnZZGxzGtKGDomFaOWUhitreE
# zOKCAMyQtHBumXErGiBvfJkQuos0NvP5VYc+XXMN1d+XuHhKLKGCF5cwgheTBgor
# BgEEAYI3AwMBMYIXgzCCF38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCDSQkZ1D46odhK7ZUQhHNK+9CN0Zx4qPFr2
# ZLResm4pXgIGZSh5LyVbGBMyMDIzMTExMDA0MjUyOS4wOTdaMASAAgH0oIHRpIHO
...
# MQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCCn2Q5+7Dq/Ethy/5TcM9Zk
# KVFbyh5CmM2nydeMTtUrqzCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIOJm
...
# xnDu46izdTNgbR/Pj64y6xk+1e37xDRVI5ps7dwa5A6LhrOy0cSsjrydVYALQm0y
# pMRYs0NQy+lk/xkx8iLqpqEFHUtz1UdvPp70Y5q9zaisnj5nU2WIXZ4atCuELU/x
# 4grOdgUewJSKEUP1kt3R8pbKIJfJjEN83pr8NtjkuPJ50Q9hZI3IuZql7InsUjZH
# jcSGJ/FCVAfWpzHlDwVxccNBPk1dLMTiOgXIDqI5aXwh/4o5XxoWD8e05K9marYk
# lZ6/I8z/UoviXiG+60HrhXU4Huifw6vv0Hmlgr1XsEGHJurKWE1ouczKN4QfaaD8
# L4a6v8/wrN5n5bRWqb7Aj8QLrxLVBpe+9WPJH8+jXhirffJeKu5LQ7XcouK8XjfZ
# IF5o5/nm47gRuZg9dcdcu2HrkrPCrz5u2WwB+vfak5HPWZIhuSndxyd58xPpN8oW
# 3ivZaKvhPqCkYdKEtZfrv0kDJg+39GtD6W6fnszup+fsx1AAfzpRr2CwFANepvFL
# mhomXZRQbMHUVx2HRij+3Z0SRrLXLwEDWolVWq+bYCm5HXN4I/qmjPk6oUojnHGH
# EBjIr1L4e+lNWgXHujqBmiy/ymacEffHGvb1noUFJwf+cYPF3eHPR9Xtj9WR5+gt
# ilNfpA5LhngGFtm2rACZn14riMd+nzGBGVIs6B+Buqk=
