...
Import-Module $PSScriptRoot\..\helpers\helper.HealthFaults.psm1
Import-Module $PSScriptRoot\..\helpers\helper.NetworkATC.psm1

$faultIntervalSeconds = $config.FaultIntervalSeconds
$clearIntervalSeconds = $faultIntervalSeconds * $config.ClearIntervalMultiplier
...
$clearSearchStart = (Get-Date).AddSeconds($clearIntervalSeconds * -1)
...
foreach ($key in $dictionary.Keys)
{
    ...
    elseif ($clearCnt -le $config.ClearThreshold)
    {
        Write-Host "The resetting events within clear interval for $key is less than $($config.ClearThreshold)."
        $ResourceID = "$($env:COMPUTERNAME): $key"
        [Microsoft.NetworkHud.Module.HciHealthUtils]::HciModifyFault($config.EntityType, $ResourceID, "", "", "", $FRApiActionDelete, $config.FaultType, $HealthUrgencyUnHealthy, "", "", "", 0)
    }
}
# SIG # Begin signature block
# MIInrQYJKoZIhvcNAQcCoIInnjCCJ5oCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC9SXo9PvAMvVrb
# TNfcXXQnoqvyzgkIpEAQJwCI8afIyKCCDYEwggX/MIID56ADAgECAhMzAAACzI61
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgCdTOdGWz
# ySmNHe9auYKKRxImiqO9I2JsdNZDNzWDqDgwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQAPA4BSRRH4JIgtzxaqMcHmx9EpC+PF67Mt1aVDCvyN
# G8WVNvCR2gdOQU3oB+2Cly/HC5g2PVXfrTXy15O/DjS4GPW5GJF2sTGCQqFSQ0dX
# Q35HLAdsSINbIKLsV3dwCz1sIohGudhga+UQ03NmQLhCes8hsjYfHNrHOdOz7oeM
# igEZsnCm6joa+L0lr9GrpiCrWruF9Wv8G9SSikkXcfaLeYhX9ys7f8lP9e/yOUbZ
# iHwArC90fa1iTMSqDlrCVIYBU2JzoaNn98rgg8MDWwXeI3k6lggfe10ExXVTmLj9
# Crk4Y+evqE6ZOQQMkrSyqZbVg8EbzXPRj79oIMHyTrbDoYIXDDCCFwgGCisGAQQB
# gjcDAwExghb4MIIW9AYJKoZIhvcNAQcCoIIW5TCCFuECAQMxDzANBglghkgBZQME
# AgEFADCCAVUGCyqGSIb3DQEJEAEEoIIBRASCAUAwggE8AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIF40ZFyHxj3bNZrIpwWSDCWBhPr5dRYMPSapi2MX
# lIzCAgZjYrxzxaEYEzIwMjIxMTEzMDUzODEwLjQxM1owBIACAfSggdSkgdEwgc4x
...
# AzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgNDV5HgsfDEATp12Q2Un0
# sYy4PX5ochaVOcCCAPN4iLgwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCBH
...
# ABy9KgDKcQXhxAjiBf3d/2FFepahHNgGG7twOEyDVRO0ZS0xZQGzun1eICZUGHty
# BHvYMJbI7qxajhrsUI1hZGv/vCnfqm0kYTP7Ebeb4qYQOD+/iu/cIbVecrOhMgeY
# K8XZS1qQ/cnSFP6Gc9B3GG26YDvFAEQoxOzT6MaROUtPxeZiZffuxw9t+IPqhDg7
# vxQbr0TV0FdChkbjLes6CZu3bJjm9CSp/eN05BR/Gz5G59/ZdV4Rh0wxXBIkpumk
# k5AIW8T80aUaNnculJVUSUeaaCcmA51xUjOvQrJ5H6fTDuICi6m5WcK3afv9DWmi
# 4tomn/A1QmAH0qeZ+nqzwsqd9l7mvWFbgwb0VPkt51MKITlaPZDT6hCos4Q48Q7X
# nIBQVSqfYct/DGpYN5stZjLXExhu24Y1yyEDpgh0U7jdmXxsbK0HVM0+K+wNTen/
# EYkAtl/iUdlXmTWylqDGSEP2Z+iqN53w7DIGjxTns0YQ7b/BnahTFoEYlTnxU9FI
# XrNkSLUXojbgvxOWHPvgh5GUPB0pA9bz36ksXiVqE9KC6boIHWe/l0/P2eP5hyAp
# 9X2g4CrAOf63M7E70uJsY33QGxpRXyuZgWxcJt7lVU3pEDwoSihBXIEsPK5MlDEy
# YRScfxLSuFv7bJIhKNzMC54dtNZb+Oz1gTAWCd6WttrT
