...
function New-AzPurviewAzureSynapseWorkspaceDataSourceObject {
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.Api20211001Preview.AzureSynapseWorkspaceDataSource]::New()
        ...
        if ($PSBoundParameters.ContainsKey('DedicatedSqlEndpoint')) {
            $Object.DedicatedSqlEndpoint = $DedicatedSqlEndpoint
        }
        ...
        if ($PSBoundParameters.ContainsKey('ServerlessSqlEndpoint')) {
            $Object.ServerlessSqlEndpoint = $ServerlessSqlEndpoint
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAw4hTF/vsWrLhn
# /9MD35N3GAvHIrLndVLwb+1sxKs7+qCCDYEwggX/MIID56ADAgECAhMzAAACUosz
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgK9B2SKGu
# LclJY2dtfbOtLgrf9B8QsRqx9a+7woMgKdkwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQBW7QCTeOgVL9kIEJIwQlm/4VH47LJxOG3qAAaqY/Gx
# j5PUwvpsWGBI+mjYlyzORLwOfLSPw6yOvmItgqJm6o+kbV+c0e7PHkU+J+EosN0F
# iaebwN/ilTGfTOe1WRg+qH0U892Y1p+GyjdglTKkn9RJydJF8qW9oJf8P6w/Quha
# /NrwJKI34T0pEworJkqIADJxgSBDT+BhI/poNB19uDPriJQ72sxtJqvPmDhCSfSD
# 8ZnfNgs7KbhTHvFXzrGubmgJWOYlES/tfc7RNbfhadN4uCyumbb+TpR1pyaT0Z+L
# jauoW8nmUMGByX3/4KIxtjSxF/mkKPYGLiqyg0bGKUrmoYIXGTCCFxUGCisGAQQB
# gjcDAwExghcFMIIXAQYJKoZIhvcNAQcCoIIW8jCCFu4CAQMxDzANBglghkgBZQME
# AgEFADCCAVkGCyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEILjepvbI5B37nbK1OjyT18Rwj8hglciwBUns1grf
# NN7OAgZiF5WjEwQYEzIwMjIwMzAxMDk0NzA4LjI2MVowBIACAfSggdikgdUwgdIx
...
# SjAaBgkqhkiG9w0BCQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEILo7
# jmqLCQjz0cH6rQUmwslo2d7rzs6IuqvJwpvpZP/RMIH6BgsqhkiG9w0BCRACLzGB
...
# hkiG9w0BAQsFAASCAgAzkoXO6PLWAldLz0kIhPtFM3WvymkAcW8lDAIttYddq3Dq
# Y2ww+J7C3MRB2VATkUU1jlgEqdML7Cv3E08sLoxwpULftv+TrYsoE7LZOCn5MxAJ
# KThla5wDekWbrG8HQnmBzK6IhzVqz+1AXkCIkxNKhYqqj+JiPm13Y2fHxpLQFfBf
# XtqNt3zdqel/zd5AIrEY67UgIJYLUgf6gNnEmkg6q8kw3ieiz4d7go6Z1eANXyUW
# ZkfZWL2Di/d2+uTVkmFX9WStdHCkgKnHLc5z3g1/ux+aK5vRAWZo2lNXspXqZGsN
# MXWdLkvzqNlIQiX+2hpSVPwNXBbrN+bpKjSgt9VYtaoX1gvgQQZ7YQ+Dvhb2BkXV
# HWCOtVhBtPAuG+UasDE0Bsk0nS2yzyX3Wo3ixvCUmOWYMI56Nsv7p1AMW061p9+7
# PzreMZF62FGoodsTmhfJnbSyxK7u3lsOttspduu00We00dWy5B4t5KgQs6KGOX+r
# TUdugQnDE7TgovPhGnggZMDBmILcWnM7KJWCrqL+GupieeB1Acz1Fra1zfw5SVQ5
# rA1FMjvDyZldWW9ZGmwLFsBuqEP4LT2apMwRTyN00k9BPjTA1RilOKPM24ig08BO
# krAlvBp9xz4Kb0+tL8GKE8Qos5ZHjtNcxfO9HDJsmvGJmSXS0g7InGr2/hC9Cw==
